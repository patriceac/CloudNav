...
$cases = @{
    ...
    MigrationReport = @{ Exe = 'CloudNavUiTests.exe'; Args = '"{OUTDIR}\ui-result.json" --migration-report'; Actions = 'vm-ui-actions.json'; Result = 'ui-result.json'; Images = @('sync-direction-restored.png','report-summary.png','report-reverse.png','report-bidirectional.png','report-all.png','report-new.png','report-partial.png') }
