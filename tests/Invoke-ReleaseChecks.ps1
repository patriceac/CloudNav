...
$cases = @{
    ...
    Ui = @{ Exe = 'CloudNavUiTests.exe'; Args = '"{OUTDIR}\ui-result.json"'; Actions = 'vm-ui-actions.json'; Result = 'ui-result.json'; Images = @('ui-main.png','ui-full-sync-analysis.png','ui-full-sync-history.png','ui-unverified.png','ui-folder-preview.png','ui-folder-confirm.png','ui-folder-applied.png') }
    Migration = @{ Exe = 'CloudNav.exe'; Args = '--demo-migration "{OUTDIR}\migration-result.json"'; Actions = 'vm-migration-actions.json'; Result = 'migration-result.json'; Images = @('migration-analysis-progress.png','migration-history-progress.png','migration-analysis-complete.png','migration-copy-progress.png','migration-copy-waiting.png','migration-copy-retrying.png','migration-verified.png','migration-cutover.png') }
