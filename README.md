...
Version 1.4.5 removes the automatic content check from Redirect only, including saved setup resumes. Redirection changes Windows folder locations without reading, comparing, copying, or downloading file contents. The title bar displays the running version.
