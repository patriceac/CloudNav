...
Version 1.4.7 moves startup, refresh, and Explorer updates off the UI thread; reuses the reviewed action plan; reduces inventory parsing and cloud probes; batches conflicts; and selects targeted lookups or directory listings according to the reviewed batch size.
